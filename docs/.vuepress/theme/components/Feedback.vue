<template>
  <div class="feedback">
    ...
    <div v-if="editOrIssueLinks">
      ...
      <div>
        <a
          href="https://github.com/kenlabs/metaverseschool/issues/new?assignees=&labels=need%2Ftriage&template=content-or-feature-suggestion.md&title=%5BCONTENT+REQUEST%5D+%28add+your+title+here%21%29"
          target="_blank"
